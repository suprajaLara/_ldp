...
import org.example.afterThrowing.Account;
...
public class MyDemoLoggingAspectForPointcut {
    ...
    @AfterThrowing(
            pointcut = "execution(* org.example.afterThrowing.dao.AccountDAO.findAccounts(..))",
            throwing = "exception"
    )
    ...
    @Before("org.example.afterThrowing.aspect.AopExpressions.excludeGetterSetter()") //reference to pointcut expression (already declared above)
